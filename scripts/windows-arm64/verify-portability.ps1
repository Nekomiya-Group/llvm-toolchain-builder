...
'@ | Set-Content $helloC
    ...
    & $clang $helloC -o $helloExe --target=aarch64-pc-windows-msvc -fuse-ld=lld 2>&1 | Out-Null
...
'@ | Set-Content $helloCpp
    ...
    & $clangpp $helloCpp -o $helloCppExe --target=aarch64-pc-windows-msvc -fuse-ld=lld -std=c++20 2>&1 | Out-Null
...
'@ | Set-Content $cpp23
    ...
    & $clangpp $cpp23 -o $cpp23Exe --target=aarch64-pc-windows-msvc -fuse-ld=lld -std=c++23 2>&1 | Out-Null
