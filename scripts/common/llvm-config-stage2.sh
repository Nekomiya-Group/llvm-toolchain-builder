...
generate_cmake_args() {
    ...
    CMAKE_ARGS+=(
        ...
        "-DCMAKE_EXE_LINKER_FLAGS=-L${STAGE1_PREFIX}/lib '-Wl,-rpath,\$ORIGIN/../lib' -Wl,-rpath,${STAGE1_PREFIX}/lib"
        "-DCMAKE_SHARED_LINKER_FLAGS=-L${STAGE1_PREFIX}/lib '-Wl,-rpath,\$ORIGIN' -Wl,-rpath,${STAGE1_PREFIX}/lib"
    )
